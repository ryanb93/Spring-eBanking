...
There are two kinds of tests in the COM3014 Frontend application: Unit tests and End to End tests.

### Running Unit Tests

The Frontend app comes preconfigured with unit tests. These are written in
...
The Frontend app comes with end-to-end tests, again written in [Jasmine][jasmine]. These tests
...
In addition, since Protractor is built upon WebDriver we need to install this.  The Frontend
